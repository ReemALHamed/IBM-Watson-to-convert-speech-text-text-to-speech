...
def on_message(self, msg):
    ...
    if "results" in data:
        if data["results"][0]["final"]:
            ...
            LAST = data
        # This print out the current fragment that we are working on
...
def on_close():
    """create a text file to store the complete and final transcript."""
    fo = open('STT.txt', 'w')
    ...
    """ write the text into the audio file """
